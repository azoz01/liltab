...
from liltab.data.dataloaders import FewShotDataLoader, ComposedDataLoader, RepeatableOutputComposedDataLoader
...
def test_repeatable_output_composed_data_loader_repeat_samples(
...
def test_repeatable_output_composed_data_loader_stop_iteration(
    resources_path
):
    num_batches = 8
    dataloader = RepeatableOutputComposedDataLoader(
